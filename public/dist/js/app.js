...
app.service('Arrangement', ["$rootScope", "$q", "$state", "IDGenerator", "BufferUploader", "$timeout", "SharedAudioContext", "$http", "CouchURL", "_ArrangementDB", "$interval", "Socket", function($rootScope, $q, $state, IDGenerator, BufferUploader, $timeout, SharedAudioContext, $http, CouchURL, _ArrangementDB, $interval, Socket){
  var self = this;
  var timeInit = 0;
  var timeSend = 0;
  var timeReceive = 0;
...
app.directive('beatsGrid', ["$compile", "EditorConfig", "Drumkits", "$rootScope", "Arrangement", function($compile, EditorConfig, Drumkits, $rootScope, Arrangement) {
...
app.controller('DrumPieceController', ["$rootScope", "$scope", "utils", "Sampler", "Arrangement", "Drumkits", function($rootScope, $scope, utils, Sampler, Arrangement, Drumkits){
...
app.controller('RecordingController', ["$scope", "SharedAudioContext", "Arrangement", "BufferedRecordingNode", function($scope, SharedAudioContext, Arrangement, BufferedRecordingNode){
...
app.controller('HomeController', ["$rootScope", "$scope", "$auth", "$state", function($rootScope, $scope, $auth, $state){
...
app.controller('LogoutController', ["$rootScope", "$scope", "$auth", "$state", function($rootScope, $scope, $auth, $state){
...
app.controller('ProjectController', ["$rootScope", "$scope", "$auth", "$state", "_UserDB", "_SharedDB", "_ArrangementDB", "CouchURL", "Account", "Cippy", function($rootScope, $scope, $auth, $state, _UserDB, _SharedDB, _ArrangementDB, CouchURL, Account, Cippy){
...
app.controller('CommunicationPanelController', ["$rootScope", "$scope", "Arrangement", "Chat", "$http", "$auth", "Account", "$stateParams", "Cippy", "CouchURL", "_ChatDB", function($rootScope, $scope, Arrangement, Chat, $http, $auth, Account, $stateParams, Cippy, CouchURL, _ChatDB){
...
app.controller('EditorController', ["$rootScope", "$scope", "Arrangement", "EditorConfig", "Sampler", "BufferedNode", "$auth", "Account", "$stateParams", "$interval", "CouchURL", function($rootScope, $scope, Arrangement, EditorConfig, Sampler, BufferedNode, $auth, Account, $stateParams, $interval, CouchURL){
    $scope.arrangement_id = $stateParams.arrangement_id;
...
app.controller('EditorControlsController', ["$rootScope", "$scope", "Scheduler", "Arrangement", "FileBrowser", "$state", function($rootScope, $scope, Scheduler, Arrangement, FileBrowser, $state){
...
app.directive('editorControls', ["$templateCache", function($templateCache) {
  return {
    restrict: 'E',
...
app.directive('progressLine', ["$rootScope", "Scheduler", "EditorConfig", "Arrangement", function($rootScope, Scheduler, EditorConfig, Arrangement) {
...
app.controller('SharePanelController', ["$rootScope", "$scope", "Arrangement", "Chat", "$http", "$auth", "Account", "$stateParams", "_SharedDB", "_UserDB", "_ArrangementDB", "CouchURL", function($rootScope, $scope, Arrangement, Chat, $http, $auth, Account, $stateParams, _SharedDB, _UserDB, _ArrangementDB, CouchURL){
 ...
 */
app.service('BufferLoader', ["$q", "$rootScope", "SharedAudioContext", "AudioCache", function($q, $rootScope, SharedAudioContext, AudioCache){
  return {
    _cache: {},
...
app.service('AudioCache', ["$http", "$q", function($http, $q) {
  var self = this;
...
app.factory('Chat', ["CouchURL", "_ChatDB", function(CouchURL, _ChatDB) {
...
(function() {
  ...
  cippy.factory('Cippy', ["$timeout", "$q", function($timeout, $q) {
...
app.factory('Socket', ["$rootScope", "IDGenerator", "$timeout", function($rootScope, IDGenerator, $timeout) {
  var self = this;
  self.socket = io();
  self.arrangement = {};
  self.currentTrack = '';
